...
import com.licheedev.serialtool.comn.Callback;
...
public class MainActivity extends BaseActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void switchSerialPort() {
        if (mOpened) {
            ...
            //mOpened = SerialPortManager.instance().open(mDevice);
            //if (mOpened) {
            ...
            // ori the callback way
            SerialPortManager.instance().open(mDevice, new Callback<Void>() {
                @Override
                public void onSuccess(@Nullable Void aVoid) {
                    mOpened = true;
                    ToastUtil.showOne(MainActivity.this, "成功打开串口");
                    updateViewState(mOpened);
                }
                ...
                public void onFailure(@NonNull Throwable tr) {
                    mOpened = false;
                    ToastUtil.showOne(MainActivity.this, "打开串口失败");
                    updateViewState(mOpened);
                }
            });
